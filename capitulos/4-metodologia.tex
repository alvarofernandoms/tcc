...
\end{enumerate}
  ...
  \item [Comparação direta com o CodeClimate:]
    ...
    spb-metrics/cocar, etc. A Figura \ref{fig:form_codeClimate} mostra este formulário para a
    importação de um repositório e análise no CodeClimate. Basta informar o
    nome do repositório; a própria ferramenta identifica qual a linguagem
    predominante e organiza as \textit{engines} necessárias para a coleta e
