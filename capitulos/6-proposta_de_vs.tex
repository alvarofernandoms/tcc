\chapter{Proposta de VS para o Mezuro}

% TODO: proposta de evolução de apresentação dos dados do Mezuro
% - aplicação do design - TODO: quais são essas evoluções
% - especificação de técnicas de VS
