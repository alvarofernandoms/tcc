...
respectivamente. Existem dois grandes conjuntos delas:
...
lançadas desde a data de publicação desta dissetação de mestrado.
...
% TODO: adicionar a página de resultados de outro software que não o Xemelê
