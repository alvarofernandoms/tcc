\chapter{Análise das Métricas do Código-fonte dos Projetos do SPB via Mezuro}

% TODO: este título está muito grande. Modificar.
...
% TODO: criar uma seção para falar do CodeClimate?
